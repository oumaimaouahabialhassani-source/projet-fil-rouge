<?php
/*
 * layout-start.php - Début du layout admin (pages dans le dossier admin/)
...
<div class="admin-shell">
  <aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
      ...
      <a href="index.php" class="admin-nav-link <?= $adminPage === 'dashboard' ? 'active' : '' ?>">
        <span class="admin-nav-icon">◈</span> Tableau de bord
      </a>
      <a href="produits.php" class="admin-nav-link <?= $adminPage === 'produits' ? 'active' : '' ?>">
        <span class="admin-nav-icon">◫</span> Produits
      </a>
      <a href="categories.php" class="admin-nav-link <?= $adminPage === 'categories' ? 'active' : '' ?>">
        <span class="admin-nav-icon">◧</span> Catégories
      </a>
      <a href="commandes.php" class="admin-nav-link <?= $adminPage === 'commandes' ? 'active' : '' ?>">
